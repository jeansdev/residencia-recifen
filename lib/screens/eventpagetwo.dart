...
class EventPageTwo extends StatefulWidget {
  @override
  _EventPageTwoState createState() => _EventPageTwoState();
}
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  Text(
                      "A cantora pernambucana reconhecida no Brasil inteiro, King Saints, vai estar presente no maior festival gratuito de tecnologia, inovação e cultura do Brasil."),
                  SizedBox(height: 16),
                  Text(
                    "Ingressos:",
                    style: TextStyle(
